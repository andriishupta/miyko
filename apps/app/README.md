...
The user-facing concept remains household for the MVP. The same flow can also represent an office team, party, picnic or another temporary group; these are use cases, not separate entities.
