...
const styles = StyleSheet.create({ intro: { alignItems: "center", gap: Spacing.two, paddingVertical: Spacing.three }, chatIcon: { width: 52, height: 52, borderRadius: Radius.pill, alignItems: "center", justifyContent: "center" }, center: { textAlign: "center" }, messageBubble: { maxWidth: "88%", gap: 4 }, response: { gap: Spacing.two }, composer: { flexDirection: "row", alignItems: "center", gap: Spacing.two }, input: { flex: 1 }, inputContent: { minHeight: 50, paddingHorizontal: Spacing.three, fontSize: 16 }, inputOutline: { borderRadius: Radius.pill } });
