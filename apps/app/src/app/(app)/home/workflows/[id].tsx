...
export default function WorkflowScreen() {
  ...
  const membersById = new Map(members.map((member) => [member.userId, member.user?.displayName ?? member.user?.email ?? "Household member"]));
